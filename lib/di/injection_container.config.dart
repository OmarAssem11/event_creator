...
import 'package:event_creator/di/app_module.dart' as _i34;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i10.RateHall>(
        () => _i10.RateHall(gh<_i8.HallsService>()));
    gh.singleton<_i6.TokenInterceptor>(_i6.TokenInterceptor(
      gh<_i3.CacheService>(),
      gh<_i6.ConnectivityManager>(),
    ));
    gh.lazySingleton<_i11.AuthService>(
        () => _i12.AuthHTTPService(gh<_i7.Dio>()));
    gh.lazySingleton<_i13.BookHall>(
        () => _i13.BookHall(gh<_i8.HallsService>()));
    ...
    gh.lazySingleton<_i18.RateCar>(() => _i18.RateCar(gh<_i14.CarsService>()));
    gh.lazySingleton<_i19.AuthRepository>(() => _i20.AuthRepositoryImpl(
          gh<_i11.AuthService>(),
          gh<_i3.CacheService>(),
        ));
    gh.lazySingleton<_i21.BookCar>(() => _i21.BookCar(gh<_i14.CarsService>()));
    gh.lazySingleton<_i22.CarsRepository>(
        () => _i23.CarsRepositoryImpl(gh<_i14.CarsService>()));
    gh.lazySingleton<_i24.GetAllCars>(
        () => _i24.GetAllCars(gh<_i22.CarsRepository>()));
    gh.lazySingleton<_i25.GetAllHalls>(
        () => _i25.GetAllHalls(gh<_i16.HallsRepository>()));
    gh.lazySingleton<_i26.GetAuthStatus>(
        () => _i26.GetAuthStatus(gh<_i19.AuthRepository>()));
    gh.lazySingleton<_i27.GetOffersHalls>(
        () => _i27.GetOffersHalls(gh<_i16.HallsRepository>()));
    gh.factory<_i28.HallsCubit>(() => _i28.HallsCubit(
          gh<_i25.GetAllHalls>(),
          gh<_i27.GetOffersHalls>(),
          gh<_i10.RateHall>(),
          gh<_i13.BookHall>(),
        ));
    gh.lazySingleton<_i29.LoginWithEmailAndPassword>(
        () => _i29.LoginWithEmailAndPassword(gh<_i19.AuthRepository>()));
    gh.lazySingleton<_i30.Logout>(() => _i30.Logout(gh<_i19.AuthRepository>()));
    gh.lazySingleton<_i31.RegisterWithEmailAndPassword>(
        () => _i31.RegisterWithEmailAndPassword(gh<_i19.AuthRepository>()));
    gh.factory<_i32.AuthCubit>(() => _i32.AuthCubit(
          gh<_i31.RegisterWithEmailAndPassword>(),
          gh<_i29.LoginWithEmailAndPassword>(),
          gh<_i30.Logout>(),
          gh<_i26.GetAuthStatus>(),
        ));
    gh.factory<_i33.CarsCubit>(() => _i33.CarsCubit(
          gh<_i24.GetAllCars>(),
          gh<_i18.RateCar>(),
          gh<_i21.BookCar>(),
        ));
