...
import 'package:event_creator/di/app_module.dart' as _i28;
...
extension GetItInjectableX on _i1.GetIt {
  ...
  _i1.GetIt init({
    ...
    gh.factory<_i22.HallsCubit>(() => _i22.HallsCubit(gh<_i21.GetAllHalls>()));
    gh.lazySingleton<_i23.LoginWithEmailAndPassword>(
        () => _i23.LoginWithEmailAndPassword(gh<_i16.AuthRepository>()));
    gh.lazySingleton<_i24.Logout>(() => _i24.Logout(gh<_i16.AuthRepository>()));
    gh.lazySingleton<_i25.RegisterWithEmailAndPassword>(
        () => _i25.RegisterWithEmailAndPassword(gh<_i16.AuthRepository>()));
    gh.factory<_i26.AuthCubit>(() => _i26.AuthCubit(
          gh<_i25.RegisterWithEmailAndPassword>(),
          gh<_i23.LoginWithEmailAndPassword>(),
          gh<_i24.Logout>(),
          gh<_i10.AuthService>(),
        ));
    gh.factory<_i27.CarsCubit>(() => _i27.CarsCubit(gh<_i20.GetAllCars>()));
    return this;
  }
}
